<template>
  ...
  <div class="full bg bg-white h-[140px] flex flex-col gap-5">
    <div class="container mx-auto row1 flex flex-row gap-[80px] items-center mt-2">
      <h1
      ...
      <div class="buttons flex gap-4 items-center">
        ...
        <div>
          <i
            class="fa-regular fa-heart p-3 bg-[#EBEFF3] rounded-md text-[#545D6A] cursor-pointer mt-5 hover:bg-[#d2d6da]"></i>
          <p
            class="count font['Roboto'] text-[10px] w-[20px] h-[20px] flex justify-center items-center bg-red-500 text-white rounded-full">
            11
          </p>
